...
Η εγκατάσταση του Eclipse ακολουθεί. Μετακινηθείτε στην [ιστοσελίδα των λήψεων](https://www.eclipse.org/downloads/). Πατήστε το **Download x86_64** και θα κατέβει ένα αρχείο με το όνομα **eclipse-inst-jre-linux64.tar.gz**.
